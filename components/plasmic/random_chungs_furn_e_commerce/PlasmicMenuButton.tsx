...
import * as sty from "./PlasmicMenuButton.module.css"; // plasmic-import: SX13IGuMlIxNEf/css

import BarsIcon from "./icons/PlasmicIcon__Bars"; // plasmic-import: IAU3FXJJKOvfv7/icon
import TimesIcon from "./icons/PlasmicIcon__Times"; // plasmic-import: 9fKZuAf_vc-Bzn/icon
    ...
    >
      ...
      >
        {(hasVariant(variants, "expanded", "expanded") ? false : true) ? (
          <BarsIcon
            className={classNames(defaultcss.all, sty.svg__elCk, {
              [sty.svg__expanded__elCkCvDl]: hasVariant(
                variants,
                "expanded",
                "expanded"
              )
        ...
        {(hasVariant(variants, "expanded", "expanded") ? true : false) ? (
          <TimesIcon
            className={classNames(defaultcss.all, sty.svg__kwd0C, {
              [sty.svg__expanded__kwd0CCvDl]: hasVariant(
                variants,
                "expanded",
                "expanded"
              )
