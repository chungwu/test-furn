...
import * as sty from "./PlasmicFeatureItem.module.css"; // plasmic-import: zEY_byEQ9HCDq/css
...
function PlasmicFeatureItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.box__lUetk)} />

      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__tNh)}
      >
        <div
        ...
        <div className={classNames(defaultcss.all, sty.box__rFaIa)}>
          <div
            className={classNames(
              defaultcss.all,
              defaultcss.__wab_text,
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box___7FWsK)}
        >
          <LinkButton
