...
import * as sty from "./PlasmicProductCard.module.css"; // plasmic-import: 4qNi-fYbHkTINQ/css

import ShoppingCartIcon from "./icons/PlasmicIcon__ShoppingCart"; // plasmic-import: ksPwB2C-Q3dF8X/icon
import HeartOIcon from "./icons/PlasmicIcon__HeartO"; // plasmic-import: GAREoartVA_Cwr/icon
import ExpandIcon from "./icons/PlasmicIcon__Expand"; // plasmic-import: Fo-W7tqLDO_6qg/icon
...
function PlasmicProductCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.box__mmYxO)}>
        <p.PlasmicSlot
          defaultContents={
            <img
              ...
              role={"img"}
              src={"/plasmic/random_chungs_furn_e_commerce/images/f1.bin"}
            />
          }
          value={args.image}
        />
        ...
        {(hasVariant(variants, "onSale", "onSale") ? true : false) ? (
          <div
            className={classNames(defaultcss.all, sty.box__w7OBk, {
              [sty.box__onSale__w7OBksgjsl]: hasVariant(
                variants,
                "onSale",
                "onSale"
              )
        ...
        {(triggers.hover_root ? true : false) ? (
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(defaultcss.all, sty.box__xqSc)}
          >
            <ShoppingCartIcon
              className={classNames(defaultcss.all, sty.svg___5Uzbf)}
              role={"img"}
            />
            ...
            <HeartOIcon
              className={classNames(defaultcss.all, sty.svg__qetAe)}
              role={"img"}
            />

            <ExpandIcon
              className={classNames(defaultcss.all, sty.svg__w3IbZ)}
              role={"img"}
            />
          </p.Stack>
        ) : null}
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__kYywF)}
      >
        <p.PlasmicSlot
