...
import * as sty from "./PlasmicBlogPost.module.css"; // plasmic-import: xXRlJBYW7Nhstt/css
  ...
  return (
    ...
    >
      {(hasVariant(variants, "long", "long") ? false : true) ? (
        <div
          className={classNames(defaultcss.all, sty.box__zme9N, {
            [sty.box__long__zme9NnqSpo]: hasVariant(variants, "long", "long")
          })}
        >
          <p.PlasmicSlot
            defaultContents={
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__aVm1B, {
          [sty.box__long__aVm1BnqSpo]: hasVariant(variants, "long", "long")
        })}
      >
        <p.PlasmicSlot
